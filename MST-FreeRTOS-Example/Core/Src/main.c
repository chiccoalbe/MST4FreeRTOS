...
/*
#include "../FreeRTOS-Specific/include/FreeRTOS.h"                   // ARM.FreeRTOS::RTOS:Core
#include "../FreeRTOS-Specific/include/task.h"                       // ARM.FreeRTOS::RTOS:Core
#include "../FreeRTOS-Specific/include/event_groups.h"               // ARM.FreeRTOS::RTOS:Event Groups
#include "../FreeRTOS-Specific/include/semphr.h"                     // ARM.FreeRTOS::RTOS:Core
*/
#include <stdio.h>
#include "string.h"
#include "FreeRTOS.h"
...
SemaphoreHandle_t xBinarySemUART2;
uint8_t transmit[10];
int length;
