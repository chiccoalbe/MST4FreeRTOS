...
\#define \mbox{\hyperlink{_m_s_t_scheduler_8h_aa07ee2f925db16beaf235590c336d015}{mst\+\_\+\+USE\+\_\+\+SPORADIC\+\_\+\+SERVER}}~1
\begin{DoxyCompactList}\small\item\em Usage of sporadic server. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Macro indicating STM32 testing environment. \end{DoxyCompactList}\item 
\#define \mbox{\hyperlink{_m_s_t_scheduler_8h_a795e545979bdaa7a589a4d3a88b1000e}{NOTIFY\+\_\+\+INTERARRIVAL\+\_\+\+TIMER}}~(1 $<$$<$ 0)
\begin{DoxyCompactList}\small\item\em Includes the HAL library for STM32\+F4 boards. \end{DoxyCompactList}\item 
\Hypertarget{_m_s_t_scheduler_8h_a1af064ca07ad7c8bf848949de674f870}\label{_m_s_t_scheduler_8h_a1af064ca07ad7c8bf848949de674f870} 
\#define {\bfseries NOTIFY\+\_\+\+USER\+\_\+\+REQUEST}~(1 $<$$<$ 1)
\end{DoxyCompactItemize}
\doxysubsubsection*{Functions}
\begin{DoxyCompactItemize}
\item 
void \mbox{\hyperlink{_m_s_t_scheduler_8h_aa1da0320aadb954f0b613dde3b26d82a}{v\+MSTScheduler\+Init}} (void)
\begin{DoxyCompactList}\small\item\em Initializes the MST Scheduler. \end{DoxyCompactList}\item 
...
2024 
\end{DoxyDate}
This file contains definitions and function prototypes for the Modello STandard (MST) scheduler library, which extends Free\+RTOS. 
...
\item 2\+: Using software timers. Highly suggested 
\end{DoxyItemize}\Hypertarget{_m_s_t_scheduler_8h_aa07ee2f925db16beaf235590c336d015}\index{MSTScheduler.h@{MSTScheduler.h}!mst\_USE\_SPORADIC\_SERVER@{mst\_USE\_SPORADIC\_SERVER}}
\index{mst\_USE\_SPORADIC\_SERVER@{mst\_USE\_SPORADIC\_SERVER}!MSTScheduler.h@{MSTScheduler.h}}
\doxysubsubsection{\texorpdfstring{mst\_USE\_SPORADIC\_SERVER}{mst\_USE\_SPORADIC\_SERVER}}
{\footnotesize\ttfamily \label{_m_s_t_scheduler_8h_aa07ee2f925db16beaf235590c336d015} 
\#define mst\+\_\+\+USE\+\_\+\+SPORADIC\+\_\+\+SERVER~1}



Usage of sporadic server. 

If not selected sporadic tasks will be served without the usage of server This will mean that sporadics are ran with user-\/set priority The sporadic server is used only in case of static scheduling (e.\+g. RMS) \Hypertarget{_m_s_t_scheduler_8h_a795e545979bdaa7a589a4d3a88b1000e}\index{MSTScheduler.h@{MSTScheduler.h}!NOTIFY\_INTERARRIVAL\_TIMER@{NOTIFY\_INTERARRIVAL\_TIMER}}
\index{NOTIFY\_INTERARRIVAL\_TIMER@{NOTIFY\_INTERARRIVAL\_TIMER}!MSTScheduler.h@{MSTScheduler.h}}
\doxysubsubsection{\texorpdfstring{NOTIFY\_INTERARRIVAL\_TIMER}{NOTIFY\_INTERARRIVAL\_TIMER}}
{\footnotesize\ttfamily \label{_m_s_t_scheduler_8h_a795e545979bdaa7a589a4d3a88b1000e} 
\#define NOTIFY\+\_\+\+INTERARRIVAL\+\_\+\+TIMER~(1 $<$$<$ 0)}
...
This function sets up the MST scheduler, preparing it to manage tasks based on the selected scheduling policy. When using MST call this and not "{}v\+Task\+Start\+Scheduler();"{} \Hypertarget{_m_s_t_scheduler_8h_a492648b07031a66c57fb4bdd663fcd1b}\index{MSTScheduler.h@{MSTScheduler.h}!vMSTSchedulerStart@{vMSTSchedulerStart}}
...
{\em pv\+Parameters} & Parameters passed into the job. \\
\hline
{\em ux\+Priority} & Priority of the job (only used if mst\+\_\+sched\+SCHEDULING\+\_\+\+POLICY mst\+\_\+sched\+SCHEDULING\+\_\+\+DEFAULT). \\
\hline
{\em px\+Created\+Task} & Pointer to the job handle. \\
\hline
